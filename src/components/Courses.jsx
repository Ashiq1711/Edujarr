...
const Courses = () => {
  return (
    <div className="bg-custom-gradient">
      <Container>
        <div className="text-center md:w-[550px] mx-auto py-10">
          <Title
            className={"text-white"}
            text1={"Why"}
            text2={"Learn"}
            text3={"With Our Courses?"}
          />
        ...
        <div className="flex justify-between items-center gap-8 md:gap-0 flex-col md:flex-row py-10 md:py-32 md:gap-5">
          <div className="w-[331px] flex flex-col gap-8 text-center items-center ">
            <img className="w-16" src={icon1} alt="" />
            <h1 className="text-2xl font-bold font-font2 text-white">
              01. Learn
            </h1>
            <p className="text-[18px] leading-7 font-font1 text-white">
