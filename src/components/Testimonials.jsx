    ...
    <div className="bg-custom2">
        <Container>
            ...
            <div>
                ...
                <p className='text-[25px] font-medium text-[#4E596B] font-font2 leading-relaxed py-4 text-center'>What our student say about us</p>
            </div>
...
<div className="flex items-center gap-6 px-5 py-8">
  ...
  <div className="px-5 pb-5">
    <a href="#">
      <h5 className="">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </h5>
    </a>
